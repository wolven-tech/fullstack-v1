# Getting Started with Fullstack V1
...
- **[Node.js](https://nodejs.org/)** v18+ - Alternative runtime (optional)
...
```bash
git clone https://github.com/your-org/fullstack-v1.git
cd fullstack-v1
```
...
bun dev:app    # Main app on localhost:3000
bun dev:web    # Marketing on localhost:3001
```
